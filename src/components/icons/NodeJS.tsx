...
export default function NodejsIcon({ className = "", size = 24, ...props }) {
  // 依原本的 viewBox 比例 (256:292) 計算高度
  const height = (size * 292) / 256;
  ...
  return (
    ...
    >
      ...
      <path
        fill="url(#nodejs_paint_a)"
        d="M134.923 1.832c-4.344-2.443-9.502-2.443-13.846 0L6.787 67.801C2.443 70.244 0 74.859 0 79.745v132.208c0 4.887 2.715 9.502 6.787 11.945l114.29 65.968c4.344 2.444 9.502 2.444 13.846 0l114.29-65.968c4.344-2.443 6.787-7.058 6.787-11.945V79.745c0-4.886-2.715-9.501-6.787-11.944L134.923 1.832Z"
      />

      <mask id="nodejs_mask_d" fill="#fff">
        <use xlinkHref="#nodejs_path_b" />
      </mask>
      <path
        fill="url(#nodejs_paint_c)"
        ...
        mask="url(#nodejs_mask_d)"
      />

      <mask id="nodejs_mask_g" fill="#fff">
        <use xlinkHref="#nodejs_path_e" />
      </mask>
      <path
        fill="url(#nodejs_paint_f)"
